...
const inputElement = document.querySelectorAll(".birthdate");
...
const setErrorMessage = "Vous devez être majeur pour vous inscrire !"
// Message error
const message = {
...
if (checkIfMajor(inputElement, setErrorMessage)) {
    formBg.style.display = 'none';
    modalSuccess.style.display = 'flex';
    form.reset();
} else {
